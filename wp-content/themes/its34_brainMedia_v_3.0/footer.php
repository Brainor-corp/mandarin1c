...
<footer>
    <div class="container nav-container">
        <div class="row mt-3 justify-content-around">
            ...
            <div class="col-md-auto col-12 decoration-none text-center">
                <a class="mr-2" href="<?php echo get_site_url(); ?>/about-us">О нас</a>
                <a class="mr-2" href="<?php echo get_site_url(); ?>/products">Тарифы</a>
                <a class="mr-2" href="<?php echo get_site_url(); ?>/catalog">Каталог</a>
                <a class="mr-2" href="<?php echo get_site_url(); ?>/stati">Новости</a>
                <a class="mr-2" href="<?php echo get_site_url(); ?>/calculator">Калькулятор</a>
                <a class="mr-2" href="<?php echo get_site_url(); ?>/contacts">Контакты</a>
            </div>
        </div>
    </div>
    <!--[if gte IE 9]>
    <script>
        ...
        function footerToBottom() {
            ...
            $('.content').css({'min-height': browserHeight - footerOuterHeight - mainHeightMarginPaddingBorder,});
        };footerToBottom();
    ...
    <!--    <script src="-->
    <?php //echo get_template_directory_uri(); ?><!--/ITS-new/plugins/OwlCarousel/dist/owl.carousel.min.js"></script>-->
    ...
    <!--<script src="--><?php //echo get_template_directory_uri(); ?><!--/ITS-new/js/fixed_header.js"></script>-->
